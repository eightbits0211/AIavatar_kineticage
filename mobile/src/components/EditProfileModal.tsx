...
const styles = StyleSheet.create({
  ...
  fieldLabel: { ...typography.bodyBold, color: NAVY, marginTop: spacing.md, marginBottom: spacing.sm },
  input: {
    height: 48,
  ...
  genderText: { ...typography.caption, color: NAVY, fontFamily: 'Inter_600SemiBold' },
